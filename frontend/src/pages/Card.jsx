      ...
      <div>
        {
          cartData.map((item, index) => {
            ...
            return (
              <div key={index} className='py-4 border-t border-b text-gray-700 grid grid-cols-[4fr_0.5fr_0.0.5fr] sm:grid-cols-[4fr_3fr_0.5fr] items-center gap-4'>
                ...
                <img onClick={() => updateQuantity(item._id, item.sizes, 0)} className='w-4' src={assets.bin_icon} alt="" />
