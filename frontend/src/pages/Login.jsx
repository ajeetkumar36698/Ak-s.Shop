...
const Login = () => {
  const [currentState, setCurrentStata] = useState('Login')
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col items-center w-[90%] sm:max-w-96 m-auto mt-14 gap-14 text-gray-800'>
      ...
      <div className='w-full flex justify-between text-sm mt-[-8px]'>
        ...
        {
          currentState == "Login"
            ? <p onClick={() => setCurrentStata('Sign up')} className='cursor-pointer'>Create account</p>
            :
            <p onClick={() => setCurrentStata('Login')} className='cursor-pointer'>Login Here</p>
        }
