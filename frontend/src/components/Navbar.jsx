...
const Navbar = () => {
    ...
    return (
        <div className='flex items-center justify-between py-5 font-medium'>
            <Link to='/'><img src={assets.logo1} alt="" className='w-20' /></Link>
            ...
            <div className='flex items-center gap-6'>
                ...
                <Link to='/card' className='relative'>
                    ...
                    <p className='absolute right-[-5px] bottom-[-5px] w-4 leading-4 bg-black text-white aspect-square rounded-full text-[8px] '>{getCartCount()}</p>
                </Link>
